/**
 *  Aeon Home Energy Meter + C3  (modified by B.Cloud to be Gen5 based on these instructions...
...
// metadata
metadata {
	definition (name: "AEON HEM Gen5", namespace: "BCloud", author: "BCLoud") {
	...
	tiles (scale: 2) {
		...
		//DEFAULT valueTile("list-energy", "device.energy") {
		//DEFAULT	state "default", label:'${currentValue} kWh', icon: "st.Lighting.light14"
		valueTile("list-energy", "device.power") {
			state "default", label:'${currentValue} Watts', icon: "st.Lighting.light14"
